"""
Mamdani-Gated Multimodal Transformer (MGM-TB-Net)
...
class MGMTBNet(nn.Module):
    """
    MGM-TB-Net: Mamdani-Gated Multimodal Transformer for Robust TB Detection.
